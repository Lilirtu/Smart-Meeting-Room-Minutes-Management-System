...
class RoomFeature extends Model { 
    ...
    protected $table = 'RoomFeature'; // let laravel know in which table we work to avoid confusion because laravel take the default exemple users for User and here we use Users so to not make confusion
    ...
    protected $fillable = ['RoomId', 'FeatureId']; // to let laravel know which columns can be filled because by defaults it blocks the assignment on all field
    ...
    public function feature(){
        return $this->belongsTo(Feature::class, 'FeatureId', 'Id');
    }
